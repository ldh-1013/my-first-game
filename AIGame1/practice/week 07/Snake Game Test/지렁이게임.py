...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_ESCAPE:
                ...
                if scene == TITLE and title_sub == TITLE_GUIDE:
                    ...
                    title_sub = TITLE_MENU  # 가이드 화면에서 ESC → 메뉴로 복귀
    ...
    if scene == TITLE:
        ...
        if title_sub == TITLE_MENU:
            ...
            screen.blit(hint_surf, (WIDTH // 2 - hint_surf.get_width() // 2, HEIGHT - 45))
            ...
            screen.blit(guide_title, (WIDTH // 2 - guide_title.get_width() // 2, 30))

            pygame.draw.line(screen, (100, 60, 20), (60, 72), (WIDTH - 60, 72), 2)
            ...
            guide_sections = [
                ...
                ("[ 먹이 종류 ]", (120, 60, 10), [
                    ...
                    "노란 먹이  :  +15 Pts  /  몸 길이 감소",

                    "주황 먹이  :  +30 Pts  /  타이머 한정 등장",

                    "빨간 먹이  :  -20 Pts  /  몸 길이 증가  (조심!)",

                ]),

                ("[ 게임 규칙 ]", (120, 60, 10), [

                    "요요 게이지가 가득 차면 -20 Pts & 몸 길이 +",

                    "유령 모드 중엔 벽·장애물을 통과할 수 있어요",

                    "특수 동물은 70점마다 등장, 먹으면 랜덤 효과 발동",

                    "600 Pts 달성 후 중앙 출구에 도달하면 클리어!",
            ...
            for section_title, title_color, lines in guide_sections:

                sec_surf = font_ko_mid.render(section_title, True, title_color)

                screen.blit(sec_surf, (60, cy))
            ...
            screen.blit(back_surf, (WIDTH // 2 - back_surf.get_width() // 2, HEIGHT - 40))
