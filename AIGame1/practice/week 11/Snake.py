...
def resource_path(relative_path: str) -> str:
    """PyInstaller 패키징 환경과 일반 실행 환경 모두에서 올바른 에셋 경로를 반환합니다."""
...
# ── 폰트 ──
try:
    font_en_big   = pygame.font.Font(resource_path("assets/fonts/AGENCYB.TTF"), 50)
    font_en_mid   = pygame.font.Font(resource_path("assets/fonts/AGENCYB.TTF"), 28)
    font_en_small = pygame.font.Font(resource_path("assets/fonts/AGENCYB.TTF"), 18)
    font_ko_mid   = pygame.font.Font(resource_path("assets/fonts/gmar.TTF"), 22)
    font_ko_small = pygame.font.Font(resource_path("assets/fonts/gmar.TTF"), 16)
except Exception:
...
eat_sound         = _load_sound(resource_path("assets/sounds/eat.mp3"))
minus_eat_sound   = _load_sound(resource_path("assets/sounds/minus eat.mp3"))
die_sound         = _load_sound(resource_path("assets/sounds/die.mp3"))
complete_sound    = _load_sound(resource_path("assets/sounds/Completed.wav"))
choice_sound      = _load_sound(resource_path("assets/sounds/choice.wav"))
lulu_sound        = _load_sound(resource_path("assets/sounds/lulu.wav"))
warning_sound     = _load_sound(resource_path("assets/sounds/warning.mp3"))
portal_open_sound = _load_sound(resource_path("assets/sounds/potalopen.wav"))
portal_seal_sound = _load_sound(resource_path("assets/sounds/potalsealed.wav"))
ghost_sound       = _load_sound(resource_path("assets/sounds/Ghost.mp3"))
star_sound        = _load_sound(resource_path("assets/sounds/Star.mp3"))
star_on_sound     = _load_sound(resource_path("assets/sounds/Star_on.wav"))
combo_sounds: list = []
for _i in range(1, 8):
    _s = _load_sound(resource_path(f"assets/sounds/combo/combo{_i}.mp3"))
    if _s:
...
green_food_img  = _load_img(resource_path("assets/images/green.png"),  (22, 22))
yellow_food_img = _load_img(resource_path("assets/images/yellow.png"), (26, 26))
orange_food_img = _load_img(resource_path("assets/images/orange.png"), (24, 24))

try:
    sand1 = pygame.image.load(resource_path("assets/images/sand1.png")).convert_alpha()
    sand2 = pygame.image.load(resource_path("assets/images/sand2.png")).convert_alpha()
    sand3 = pygame.image.load(resource_path("assets/images/sand3.png")).convert_alpha()
...
try:
    try:
        player_sheet = pygame.image.load(resource_path("assets/images/animal.png")).convert_alpha()
    except Exception:
